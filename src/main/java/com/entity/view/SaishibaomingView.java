...
public class SaishibaomingView extends SaishibaomingEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 报名状态的值
		*/
		private String saishibaomingYesnoValue;
	...
	public SaishibaomingView(SaishibaomingEntity saishibaomingEntity) {
		try {
			...
			* 获取： 报名状态的值
			*/
			public String getSaishibaomingYesnoValue() {
				return saishibaomingYesnoValue;
			}
			/**
			* 设置： 报名状态的值
			*/
			public void setSaishibaomingYesnoValue(String saishibaomingYesnoValue) {
				this.saishibaomingYesnoValue = saishibaomingYesnoValue;
			}
