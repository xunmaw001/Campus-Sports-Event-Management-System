    ...
    */
    ...
    public R save(@RequestBody RichengEntity richeng, HttpServletRequest request){
        ...
        Wrapper<RichengEntity> queryWrapper = new EntityWrapper<RichengEntity>()
            .eq("richeng_name", richeng.getRichengName())
            .eq("richeng_changci", richeng.getRichengChangci())
            .eq("shijianduan_types", richeng.getShijianduanTypes())
            ;
...
//                            richengEntity.setRichengName(data.get(0));                    //日程标题 要改的
//                            richengEntity.setRichengChangci(data.get(0));                    //场次 要改的
//                            richengEntity.setShijianduanTypes(Integer.valueOf(data.get(0)));   //时间段 要改的
//                            richengEntity.setRichengTime(sdf.parse(data.get(0)));          //时间信息 要改的
