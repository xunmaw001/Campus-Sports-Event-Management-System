...
//            return R.error(511,"永远不会进入");
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            ...
                            yonghuEntity.setYonghuName(data.get(1));                    //运动员姓名 要改的
                            yonghuEntity.setYonghuPhoto("");//详情和图片
                            yonghuEntity.setYonghuPhone(data.get(2));                    //手机号 要改的
                            yonghuEntity.setYonghuEmail(data.get(3));                    //电子邮箱 要改的
                            yonghuEntity.setSexTypes(Integer.valueOf(data.get(4)));   //性别 要改的
                            ...
                            //把要查询是否重复的字段放入map中
                                ...
                                if(seachFields.containsKey("yonghuPhone")){
                                    ...
                                    yonghuPhone.add(data.get(2));//要改的
                                }else{
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", "运动员");
        R r = R.ok();
        r.put("token", token);
        r.put("role","运动员");
