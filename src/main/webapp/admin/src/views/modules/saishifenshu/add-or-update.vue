...
<!--                <el-col :span="12"  v-if="sessionTable !='saishi'">
                    <el-form-item class="select" v-if="type!='info'"  label="赛事信息" prop="saishiId">
                        <el-select v-model="ruleForm.saishiId" :disabled="ro.saishiId" filterable placeholder="请选择赛事信息" @change="saishiChange">
                            <el-option
...
<!--                <el-col :span="12"  v-if="sessionTable !='yonghu'">
                    <el-form-item class="select" v-if="type!='info'"  label="运动员" prop="yonghuId">
                        <el-select v-model="ruleForm.yonghuId" :disabled="ro.yonghuId" filterable placeholder="请选择运动员" @change="yonghuChange">
                            <el-option
               ...
               <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="运动员姓名" prop="yonghuName">
                        <el-input v-model="yonghuForm.yonghuName"
                                  placeholder="运动员姓名" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="运动员姓名" prop="yonghuName">
                            <el-input v-model="ruleForm.yonghuName"
                                      placeholder="运动员姓名" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="sessionTable !='yonghu' ">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="赛事成绩" prop="saishifenshuChengji">
                       <el-input v-model="ruleForm.saishifenshuChengji"
                                 placeholder="赛事成绩" clearable  :readonly="ro.saishifenshuChengji"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="赛事成绩" prop="saishifenshuChengji">
                           <el-input v-model="ruleForm.saishifenshuChengji"
                                     placeholder="赛事成绩" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="详情信息" prop="saishifenshuText">
                        <el-input type="textarea"  :readonly="ro.saishifenshuText" v-model="ruleForm.saishifenshuText" placeholder="详情信息"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.saishifenshuText" label="详情信息" prop="saishifenshuText">
                            <span v-html="ruleForm.saishifenshuText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   yonghuId: [
                              { required: true, message: '运动员不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   saishifenshuChengji: [
                              { required: true, message: '赛事成绩不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
		 ...
		 debugger
			 if(this.$route.query.saishiId != null && this.$route.query.yonghuId != null){
				 this.ruleForm.saishiId = this.$route.query.saishiId
				 this.ruleForm.yonghuId = this.$route.query.yonghuId
				 this.yonghuChange(this.ruleForm.yonghuId)
				 this.saishiChange(this.ruleForm.saishiId)
			 }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`saishifenshu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
