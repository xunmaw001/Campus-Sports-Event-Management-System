    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.saishibaomingYesnoTypes" label="报名状态" prop="saishibaomingYesnoTypes">
                        <el-input v-model="ruleForm.saishibaomingYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.saishibaomingYesnoText" label="报名结果" prop="saishibaomingYesnoText">
                        <span v-html="ruleForm.saishibaomingYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    saishiId: false,
                    yonghuId: false,
                    saishibaomingYesnoTypes: false,
                    saishibaomingYesnoText: false,
                },
                ruleForm: {
                    saishiId: '',
                    yonghuId: '',
                    saishibaomingYesnoTypes: '',
                    saishibaomingYesnoText: '',
                },
                saishibaomingYesnoTypesOptions : [],
                saishiOptions : [],
                yonghuOptions : [],
                rules: {
                   saishiId: [
                   ...
                   saishibaomingYesnoText: [
                              { required: true, message: '报名结果不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=saishibaoming_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.saishibaomingYesnoTypesOptions = data.data.list;
                    }
                });
